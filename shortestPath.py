class Dijkstra:
    ...
    def shortest_path(self):
        ...
        closes = []
        while True:
            opens.append([[str(k), v] for k, v in self.open_list.items()])
            ...
            closes.append([[str(k), v] for k, v in self.closed_list.items()])
            ...
            if min_node == self.goal:  # 如果节点为终点
                ...
                print('找到最短路径， 结束！')
                return shortest_path[::-1], self.min_dis, opens, closes
...
def data_format(list):
    ...
    for l in list:
        if l[0] not in g:
            g.update({l[0]: {l[1]: int(l[2])}})
        else:
            g[l[0]].update({l[1]: int(l[2])})
    return g

# if __name__ == '__main__':
#     g_raw = [['1', '2', '2'], ['1', '2', '4'], ['2', '4', '3'], ['2', '5', '11']]
#     print(data_format(g_raw))
#     g = {'1': {'2': 2, '4': 1},
#          '2': {'4': 3, '5': 11},
#          '3': {'1': 4, '6': 5},
#          '4': {'3': 2, '6': 8, '7': 4, '5': 2},
